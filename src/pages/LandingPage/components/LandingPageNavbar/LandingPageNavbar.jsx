...
const LandingPageNavbar = () => {
  ...
  return (
    <div className="navbar container landing-nav px-3 px-md-0">
      <motion.span animate={{opacity: 1,scale: 1}} className='icon-span' transition={{duration: 0.5}} initial={{opacity: 0,scale: 0.5}}>
