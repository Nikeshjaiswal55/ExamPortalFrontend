    ...
    <div className="hero row justify-content-center ps-md-4">
      <div className="hero-wrapper col-md-4 col-12 ps-md-5 d-flex align-items-center">
        <motion.div
          ...
          animate="animate"
        >
          <motion.h2 variant={textVariants} className='text-h2 h4 mb-5'> Welcome to ExamEasy!! </motion.h2>
          <motion.h1 variant={textVariants} class="display-2 px-1 text-bold px-md-0"> With Moto <br></br> Your Action Our Reaction... </motion.h1>
