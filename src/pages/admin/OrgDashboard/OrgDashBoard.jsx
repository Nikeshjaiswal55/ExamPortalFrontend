        ...
        <div className="  col-12 row m-0 d-flex">
          <div className="row d-flex  p-1 g-1">
            <div className="row d-flex  justify-content-around  p-2 pt-0 g-1">
              <div className="col  col-xl-3 p-3 box rounded-3">
                <h1> Your Created Exams </h1>
              </div>
              <div className="col col-xl-3  offset-sm-1 p-3 box rounded-3">
            ...
            <div className="row m-0  d-flex justify-content-between box rounded-3 w-100 ">
              ...
              <div className=" row  w-100 g-1 box rounded-3 ">
                <TableResponsive />
              </div>
            </div>
          </div>
