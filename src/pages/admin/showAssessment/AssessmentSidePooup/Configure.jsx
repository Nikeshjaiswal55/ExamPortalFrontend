...
export default function Configure() {
    const [duration,setDuration] = useState('52:25:55');
                    ...
                    >
                        <div className="row d-flex justify-content-around  align-items-center">
                            ...
                            <div className=' w-100'>
                                ...
                                <ErrorMessage component={"div"} name='examBranch' className=' input-error' />
                            </div>
                            <CustomButton className={"px-5 my-3  w-auto"} buttonText={"Save"} onButtonClick={handleSubmit} />
                        </div>
