                        ...
                        <div className=" w-100 h-100 m-0  p-0 g-md-0 overflow-auto bg-transparent">
                            <div className="row w-100  chart-box   p-0 m-0 " style={{height: "20rem"}}>
                                <div className="col-12 col-md-4  d-flex  flex-column flex-lg-row    align-items-center   justify-content-center rounded-3">
                                    {barChatData && barChartLabels && <div className=' chart-parent w-100 h-75  d-flex align-items-center  bg-white rounded-3 py-3 justify-content-center '>
                            ...
                            {data?.length ? <div className="row m-0  d-flex justify-content-between bg-white  rounded-3 w-100  p-2   ">
                                ...
                                <Accordion className='  my-2 p-0 p-md-2 ' >
                                    ...
                                    {data && data?.map((value,index) => {
                                        return <>
                                            <div className=' border rounded py-3 px-2 my-1'>   <div className=' w-100 d-flex  flex-column flex-md-row gap-2  flex-wrap  justify-content-start  align-items-start  align-items-md-center justify-content-md-between fw-bold '>
                                                <div className=' ps-3 ps-md-0 w-auto text-start text-capitalize'>{value?.assessmentName} </div>
                                                <div className=' ps-3 ps-md-0 w-auto  text-start text-capitalize'>{value?.assessmentDuration} </div>
                                                <div className=' ps-3 ps-md-0 w-auto  text-start text-capitalize' >{value?.assessmentDate} </div>
