...
const baseUrl = "https://examsdemoapi.ssism.org/";
// const baseUrl = "http://192.168.31.195:9091"
...
export const adminApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        getAllSnsStudent:builder.query(
            {
                query: () => {
                    return {
